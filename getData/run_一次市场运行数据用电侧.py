...
URL_EXPORT_EXCEL = 'https://pmos.sd.sgcc.com.cn:18080/trade/DaJyjgydPlantFirQuery.do?method=export'
    ...
    for f in os.listdir(folder):
        if f.endswith('.xls'):
            try:
                ...
                pass
    return max(dates) + timedelta(days=1) if dates else datetime(2025,12,31)
...
def safe_download(session, date_str, save_path):
    ...
    r = session.get(URL_EXPORT_EXCEL, headers={
        'Referer': f'https://pmos.sd.sgcc.com.cn:18080/trade/DaJyjgydPlantFirQuery.do?appkey=201&pdate={date_str}'
    }, timeout=60)
...
def main():
    ...
    token = '1cfb8ae49a7d81180a7486c45a1315174d81a5502a1d22d5e3e1d7a9801da0d5bbbd90c9b506eaa8a5ab7e1892726af9.2f496f16e922a1faa1ebcfead656febab7955f0d'
    sessionid = '9a76125b-1e2d-4409-8431-073ea25bbd16'
    folder = '一次市场运行数据用电侧'
