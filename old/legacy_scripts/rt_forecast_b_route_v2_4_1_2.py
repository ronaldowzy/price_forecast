...
def predict_one_day(
    ...
    if p_full_neg is None or p_full_neg <= p_gate_neg:
        ...
        base50 = np.where(take_spike, rtS50, rtN50)
...
def run_without_args() -> None:
    CONFIG = {
        ...
        # backtest
        "dates": "2025-10-15,2025-09-16,2025-09-08,2025-10-04,2025-07-31,2025-08-21,2025-07-11,2025-07-28,2025-07-06,2025-08-19",
